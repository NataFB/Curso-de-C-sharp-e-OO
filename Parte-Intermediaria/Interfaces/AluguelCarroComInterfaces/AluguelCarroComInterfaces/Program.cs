...
using AluguelCarroComInterfaces.Services;
...
namespace AluguelCarroSemInterfaces
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //BrazilTaxService por meio de upcasting vai ser tratado como um objeto do tipo ITaxService, o que permite que o RentalService utilize os métodos definidos na interface sem se preocupar com a implementação específica da classe BrazilTaxService.
