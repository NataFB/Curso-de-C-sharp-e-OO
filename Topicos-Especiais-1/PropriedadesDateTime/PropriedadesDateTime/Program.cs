...
namespace Propriedadesdatetime
{
    class Program
    {
        static void Main(string[] args) 
        {
            ...
            string s6 = d.ToString("yyyy-MM-dd HH:mm:ss"); // mascara de formatação (sobrecarga)
            string s7 = d.ToString("yyyy-MM-dd HH:mm:ss.fff"); // mascara de formatação (sobrecarga)
